...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            {
                var connections = await _tracker.GetConnectionForUser(recipient.UserName); //ES para ver si el usuario esta en linea en cualquier otra pantalla que no sea la de mensajes.
                if(connections != null)
                {
